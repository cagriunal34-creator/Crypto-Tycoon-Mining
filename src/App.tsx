...
function AppInner() {
  ...
  if (state.isLoading) {
    return (
      <div className="flex flex-col h-screen max-w-md mx-auto items-center justify-center text-emerald-500 bg-zinc-950">
        <RefreshCw className="animate-spin" size={48} />
        <span className="mt-4 text-sm font-black uppercase tracking-[0.2em]">Loading Game...</span>
      </div>
    );
  }
